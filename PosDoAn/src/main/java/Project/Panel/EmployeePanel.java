...
public class EmployeePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        passwordTxtField.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void passwordTxtFieldActionPerformed(ActionEvent evt) {
            }
        });

        passwordLabel.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        passwordLabel.setForeground(new java.awt.Color(48, 56, 65));
        passwordLabel.setText("MK:");

        PositionLabel.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        PositionLabel.setForeground(new java.awt.Color(48, 56, 65));
        ...
        supplierIDLabel.setForeground(new java.awt.Color(48, 56, 65));
